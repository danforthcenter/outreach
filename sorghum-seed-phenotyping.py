...
def main():
  ...
  #device, roi_objects, roi_obj_hierarchy, kept_mask, obj_area = pcv.roi_objects(img, 'cutto', roi, roi_hierarchy,
  #                                                                              id_objects, obj_hierarchy, device,
  #                                                                              debug)

  img_binary1 = np.copy(img_binary)
  #device, fill_image = pcv.fill(img_binary1, kept_mask, 300, device, debug)
  ...
  pcv.print_image(img_copy,str(filename[:-4]+"-seed-confetti.jpg"))
  ...
  pcv.print_image(maxseed, str(filename[:-4]+"-maxseed.jpg"))
