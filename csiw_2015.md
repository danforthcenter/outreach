...
```
sudo leafpad /home/pi/firstpy.py
...
def addnumbers(x,y):
	...
	str1= "add numbers "+str(x)+" and "+str(y)+" equqls:"
	print str1
	print x+y
	return
...
```
```
sudo leafpad /home/pi/secondpy.py
...
```
save the file, close it, and run it on the command line.
...
```
sudo leafpad /home/pi/thirdpy.py
